                    ...
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-12 col-lg-8 text-center">
                                <h5 className="text-white text-uppercase mb-3 animated slideInDown">THIS WORLD CLASS RESORT, FURAMA DANANG, REPUTABLE FOR BEING A CULINARY RESORT IN VIETNAM</h5>
                                <h1 className="display-3 text-white animated slideInDown mb-4">Welcome To Furama Reosort</h1>
                                <p className="fs-5 fw-medium text-white mb-4 pb-2">A culinary resort on one of the six nost luxurious beaches in the world. </p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                            <div className="service-item">
                                ...
                                <div className="p-4 text-center border border-5 border-light border-top-0">
                                    ...
                                    <p>The resort’s culinary experience features a mixture of the authentic and locally inspired Vietnamese, Asian, Italian and other European cuisines plus the best imported steaks. </p>
                        ...
                        <div className="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                            <div className="service-item">
                                ...
                                <div className="p-4 text-center border border-5 border-light border-top-0">
                                    ...
                                    <p>A well-appointed International Convention Palace with ballrooms can accommodate up to 1,000 people in style, with another ten function rooms for 50 to 300 people each.</p>
                                    <a className="fw-medium" href>Read More<i className="fa fa-arrow-right ms-2" /></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row g-0 mx-lg-0">
                        <div className="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.5s">
                            <div className="p-lg-5 ps-lg-0">
                                ...
                                <p className="mb-4 pb-2">The Furama Resort aims to make your stay in Vietnam a unique and unforgettable experience. Whether you prefer to be active or just to relax, we offer a wide range of activities and services to suit your needs.</p>
                                <div className="row g-4">
                                    <div className="col-6">
                        ...
                        <div className="col-lg-6 pe-lg-0" style={{ minHeight: '400px' }}>
                            <div className="position-relative h-100">
                                <img className="position-absolute img-fluid w-100 h-100" src="img/2-600-40_636772920499243218_HasThumb.jpg" style={{ objectFit: 'cover' }} alt="" />
                            </div>
                        </div>
                    </div>
                </div>
